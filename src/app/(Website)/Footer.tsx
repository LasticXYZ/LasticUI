    ...
    <div className="mx-auto w-full px-5 md:px-20 xl:px-40 py-10 lg:py-20">
      <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold font-syncopate uppercase text-pink-4 uppercase ">
              HOME
            </h2>
          ...
          <div>
            ...
            <ul className="text-montserrat font-medium">
              <li className="mb-4">
                <a href="https://github.com/lasticXYZ" className="hover:underline">
                  Github
                </a>
              </li>
              <li className="mb-4">
                <a
                  href="https://github.com/LasticXYZ/LasticUI/blob/main/W3FGrant_Lastic_Whitepaper.pdf"
          ...
          <div>
            ...
            <ul className="text-montserrat  font-medium">
              <li className="mb-4">
                <a href="https://docs.lastic.xyz/" className="hover:underline ">
                  Docs
                </a>
              </li>
              <li className="mb-4">
                <a href="https://blog.lastic.xyz/" className="hover:underline">
                  Medium
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="text-montserrat  font-medium">
              ...
              <li className="mb-4">
                <a href="https://t.me/+khw2i6GGYFw3NDNi" className="hover:underline">
                  Telegram
                </a>
              </li>
            </ul>
