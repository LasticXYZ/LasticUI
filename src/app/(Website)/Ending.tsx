  ...
  return (
    ...
    >
      <div className="w-full">
        {/* Text Section */}
        <div className="flex flex-col text-center items-center justify-center pt-32 -mb-32 px-32 ">
          <h2 className=" leading-normal lg:leading-snug lg:max-w-4xl pt-10 py-4 text-white text-5xl md:text-6xl lg:text-7xl font-syne font-bold">
