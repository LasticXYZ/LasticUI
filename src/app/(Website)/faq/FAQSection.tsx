...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      'The Lastic team is currently exploring this option. However, irrespective of the decision, a fee-per-transaction revenue structure is anticipated.',
  },
]
  ...
  return (
    <div className="text-gray-20 min-h-screen py-20 pt-32">
      <div className="mx-auto max-w-5xl">
        <h1 className="text-5xl text-center font-unbounded uppercase text-gray-20 font-semibold">Q&A</h1>

        {FAQ.map((item, index) => {
          return <AccordionTile key={index} question={item.question} answer={item.answer} />
        })}
      </div>
    </div>
  )
