...
type AllowedRenewals = { coreInfo: AllowedRenewalCoreInfoUnf[]; assignmentInfo: AllowedRenewalAssignmentInfo };
type AllowedRenewalsType = AllowedRenewals[];

export {
    type AllowedRenewalAssignmentInfo, type AllowedRenewalAssignmentItem, type AllowedRenewalAssignmentItemUnf,
    type AllowedRenewalCoreInfo, type AllowedRenewalCoreInfoUnf, type AllowedRenewals, type AllowedRenewalsType, type AssignmentItem,
    type AssignmentItemUnf, type CompletionInfo, type Workplan, type WorkplanAssignmentInfo, type WorkplanAssignmentInfoUnf,
