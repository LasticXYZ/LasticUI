    ...
    return (
        <div className="flex flex-col items-center justify-center border-b border-gray-9 py-20 bg-white bg-opacity-70 p-4 sm:p-12">
            <section className="mx-auto max-w-9xl px-4 mt-5 sm:px-6 lg:px-8">
                <div className='py-5'>
                    {/* Title */}
                    <h1 className="text-2xl sm:text-3xl font-syncopate font-bold text-center mb-4">Why on polkadot?</h1>

                    {/* Subtitle */}
                    <h2 className="text-lg sm:text-xl font-syncopate text-center mb-10">A deeper dive</h2>
