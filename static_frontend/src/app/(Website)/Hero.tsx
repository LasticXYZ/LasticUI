...
const Hero = () => {
  return (
    <div id='home' className="h-screen w-screen flex justify-center items-center">
      <div className='flex flex-col lg:flex-row xl:justify-between items-center w-full max-w-7xl px-4 md:px-0'>

      {/* Text Section */}
      <div className='w-full md:max-w-lg text-center lg:text-left md:px-5 lg:max-w-2xl pt-15 pb-4 md:py-20 mx-auto p-2 relative z-10'>
        <div>
        ...
        {/* Image Section */}
        <div className="w-11/12 xl:w-1/2 justify-center mx-auto relative z-10">
          <Image
