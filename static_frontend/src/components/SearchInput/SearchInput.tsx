  ...
  return (
    <form className="flex items-center">   
        ...
        <div className="relative w-full rounded-full text-gray">
            ...
            <input type="text" id="simple-search" className="bg-white px-4 mx-4 font-syncopate rounded-full border border-gray-20 text-gray-3 text-l  focus:border-gray-15 block w-full pl-10 p-2.5 " 
